...
bool crazyflie_interfaces__msg__flat_target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("crazyflie_interfaces.msg._flat_target.FlatTarget", full_classname_dest, 48) == 0);
  }
  crazyflie_interfaces__msg__FlatTarget * ros_message = _ros_message;
  {  // position
  ...
  {  // yaw_accel
    PyObject * field = PyObject_GetAttrString(_pymsg, "yaw_accel");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->yaw_accel = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of FlatTarget */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("crazyflie_interfaces.msg._flat_target");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FlatTarget");
  ...
  {  // yaw_accel
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->yaw_accel);
    {
      int rc = PyObject_SetAttrString(_pymessage, "yaw_accel", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
